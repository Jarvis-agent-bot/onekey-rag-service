import { Bot, BookOpen, ExternalLink, Info, ShieldAlert, AlertTriangle, ArrowRightLeft, Zap, AlertCircle, Lightbulb, CheckCircle, XCircle } from 'lucide-react'
...
export function RagDetails({ explanation, showActionDetails = true }: RagDetailsProps) {
  ...
  const primaryAction = actions[0] as Record<string, unknown> | undefined
  const actionDescription = primaryAction?.description as string | undefined
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {/* 无相关来源提示 */}
        {relevantSources.length === 0 && explanation.sources && explanation.sources.length > 0 && (
